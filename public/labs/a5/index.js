...
let true1 = true; // true
let false1 = false; // false
let false2 = true1 && false1; // false
let true2 = true1 || false1; // true
let true3 = !false2; // true
let true4 = numberVariable === 123; // true
let true5 = floatingPointNumber !== 321.432; // true
let false3 = numberVariable < 100; // false
let sortaTrue = '1' == 1 // true
let notTrue   = '1' === 1 // false
console.log(true1)
console.log(false1)
console.log(false2)
console.log(true2)
